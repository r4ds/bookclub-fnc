...
- orginal number of digits become meaningless
...
- Cases of repeated rots have infinite condition number
...
- sensitivity of a problem/step is governed by condition number, but sensitivity of algorithm depend son condition numbers of individual steps
